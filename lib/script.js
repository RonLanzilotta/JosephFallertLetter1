...
function generateAndSend() {
  ...
  actionNotice.innerHTML = `✓ PDF downloaded. <a href="${mailtoHref}" style="display:inline-block;margin-top:8px;padding:8px 16px;background:#15803d;color:#fff;border-radius:6px;text-decoration:none;font-weight:600;">Open Email Draft</a>`;
